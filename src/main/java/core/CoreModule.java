...
public class CoreModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(IMessagingService.class).annotatedWith(Names.named("msgService")).to(MessagingService.class);
        ...
        bind(IMessageRepository.class).annotatedWith(Names.named("msgRepo")).to(MessageRepository.class);
    }
